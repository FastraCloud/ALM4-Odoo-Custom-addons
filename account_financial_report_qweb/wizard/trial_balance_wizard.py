...
class TrialBalanceReportWizard(models.TransientModel):
    ...
    analytic_tag_ids = fields.Many2many('account.analytic.tag', 'trial_balance_report_wizard_analytic_tag_ids_rel', 'account_id','analytic_tag_ids', string = 'Analytic Tag(s)' )
    analytic_account_id = fields.Many2many('account.analytic.account','trial_balance_report_wizard_analytic_account_id_rel', 'account_id','analytic_account_id', string = 'Analytic Account(s)')
    analytic_label_id = fields.Many2many('material.label','trial_balance_report_wizard_analytic_label_id_rel', 'account_id', 'analytic_label_id', string = 'Analytic Label')
    ...
    def _prepare_report_trial_balance(self):
        ...
        return {
            ...
            'filter_analytic_account_ids': [(6, 0, self.analytic_account_id.ids)],
            'filter_analytic_tag_ids': [(6, 0, self.analytic_tag_ids.ids)],
            'filter_analytic_label_id': [(6, 0, self.analytic_label_id.ids)],
